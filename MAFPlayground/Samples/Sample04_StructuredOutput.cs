...
internal static class Sample04_StructuredOutput
{
    public static async Task Execute()
    {
        ...
        ChatClient chatClient = azureClient
                .GetChatClient("gpt-4o-mini");

        // Create the ChatClientAgent with the specified name and instructions.
        ChatClientAgent agent = chatClient.AsAIAgent(new ChatClientAgentOptions { Name = "HelpfulAssistant", ChatOptions = new ChatOptions { Instructions = "You are a helpful assistant." } });
