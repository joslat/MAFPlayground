...
/// </remarks>
internal static class Sample06_ConditionalEdges
{
    public static async Task Execute()
    {
        ...
        WorkflowVisualizerTool.PrintAll(workflow, "Sample 06: Conditional Workflow Visualization");

        // Sample spam email text (you can replace this with Resources.Read("spam.txt") if you have the file)
        string email = @"Subject: URGENT! You've Won $1,000,000!
            Dear Winner,

            Congratulations! You have been selected as the lucky winner of our international lottery!
            To claim your prize of $1,000,000, please send your bank account details immediately to:
            winner@totally-legit-lottery.xyz
